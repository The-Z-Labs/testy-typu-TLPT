...
Ogromną zaletą powstałych ram [TIBER-EU](https://www.ecb.europa.eu/paym/cyber-resilience/tiber-eu/html/index.en.html) / [TLPT (artykuły 26,27 w DORA)](https://eur-lex.europa.eu/legal-content/PL/TXT/?uri=CELEX:32022R2554#art_26) / [ART](https://www.dnb.nl/en/sector-information/cash-and-payment-systems/dnb-oversees-cyber-resilience-tests/advanced-red-teaming-art/) jest ustrukturyzowanie testów typu TLPT, w taki sposób iż wszystkie zaangażowane strony wiedzą co będzie realizowane, w jakiej kolejności oraz kto za co odpowiada. Warto na to spojrzeć po kolei i osobno oczami każdego z uczestników procesu:
...
3. Dostawca analizy zagrożeń: [Analiza zagrożeń na potrzeby TLPT](threat-intelligence.md)
